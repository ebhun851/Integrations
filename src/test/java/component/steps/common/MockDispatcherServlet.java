...
public class MockDispatcherServlet {
    ...
    public MockDispatcherServlet() {
        ...
        System.out.println("Target Environment: " + target);

        String contextConfigLocation = "application-context.xml";
    ...
    public MockHttpServletRepsonseToStringWrapper post(String url, String body, String user) {
        return service("POST", url, body, new HashMap<String, String>(), user);
    }
